...
export function CircularPortfolio() {
  ...
  return (
    <section id="work" className="relative w-full py-12 md:py-16 overflow-hidden bg-gradient-to-b from-[#fff6fe] via-[#fdf2fc] to-white border-t border-slate-100 font-sans">
